        ...
        <div className="contact__wrapper">
              ...
              <div className="address__wrap">
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html: md.render(contact.Address),
                  }}
                />
                <br />
                <br />
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html: md.render(contact.Opening_hours),
                  }}
                />
          ...
          <div className="flex buttons">
            <button className="btn-contact">
              <a href="https://www.google.com/maps/dir//Pycha+Micha+Restauracja/@49.7491469,18.5598714,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x471405a5858eef9f:0x7b70b0a47cc02a2c!2m2!1d18.629911!2d49.749168">
                Wyznacz trase
              </a>
            </button>
            <Link href="/menu">
              <a className="btn-contact link">Menu</a>
            </Link>
            <button className="btn-contact">
              <Link href="tel:+48-33-852-12-12">Zadzwoń teraz!</Link>
            </button>
          </div>
        </div>
      </div>
